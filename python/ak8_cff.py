...
def setupCustomizedAK8(process, runOnMC=False, path=None):
    ...
    process.customAK8ConstituentsTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
                                                        ...
                                                        variables = cms.PSet(CandVars,
                                                                             puppiWeight = Var("puppiWeight()", float, doc="Puppi weight",precision=20),
                                                                             puppiWeightNoLep = Var("puppiWeightNoLep()", float, doc="Puppi weight removing leptons",precision=20),
                                                                             vtxChi2 = Var("?hasTrackDetails()?vertexChi2():-1", float, doc="vertex chi2",precision=20),
                                                                             trkChi2 = Var("?hasTrackDetails()?pseudoTrack().normalizedChi2():-1", float, doc="normalized trk chi2", precision=20),
                                                                             dz = Var("?hasTrackDetails()?dz():-1", float, doc="pf dz",precision=20),
                                                                             d0 = Var("?hasTrackDetails()?dxy():-1", float, doc="pf d0",precision=20),
                                                                             d0Err = Var("?hasTrackDetails()?dxyError():-1", float, doc="pf d0 err",precision=20),
                                                                             )
                                                        )
