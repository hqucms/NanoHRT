...
#   --customise PhysicsTools/Pancakes/nanoHRT_cff.nanoHRT_customizeMC --fileout file:nano_mc_2016.root \
...
# 
# python crab.py -p pancakes_2016_mc_NANO.py -o /store/user/ncsmith/pancakes/02/ -t pancakes-02 -i minlo_2016.txt \
...
cmsDriver.py pancakes_2017_mc -n 100 --mc --eventcontent NANOAODSIM --datatier NANOAODSIM \
  ...
  --customise PhysicsTools/Pancakes/nanoHRT_cff.nanoHRT_customizeMC --fileout file:nano_mc_2017.root \
  ...
  --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring \
  --customise PhysicsTools/Pancakes/nanoHRT_cff.nanoHRT_customizeMINLOnnlops

python crab.py -p pancakes_2017_mc_NANO.py -o /store/user/ncsmith/pancakes/02/ -t pancakes-02 -i minlo_2017.txt \
...
cmsDriver.py pancakes_2018_mc -n 100 --mc --eventcontent NANOAODSIM --datatier NANOAODSIM \
  ...
  --customise PhysicsTools/Pancakes/nanoHRT_cff.nanoHRT_customizeMC --fileout file:nano_mc_2018.root \
...
python crab.py -p pancakes_2018_mc_NANO.py -o /store/user/ncsmith/pancakes/02/ -t pancakes-02 -i minlo_2018.txt \
