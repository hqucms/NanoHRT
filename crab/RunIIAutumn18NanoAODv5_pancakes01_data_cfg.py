...
process.NANOAODoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:RunIIAutumn18NanoAODv5.root'),
...
#call to customisation function nanoHRT_customizeData imported from PhysicsTools.NanoHRT.nanoHRT_cff
