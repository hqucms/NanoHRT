...
python crab.py -p pancakes_2017_data_UL_NANO.py -o /store/group/lpcbacon/pancakes/02/2017/UL/ -t pancakes-02 -i data_2017_UL.txt  --num-cores 2 --send-external \
    -s EventAwareLumiBased \
    -n 200000 --work-area crab_projects_data_2017 --max-memory 5000 \
    --json https://cms-service-dqm.web.cern.ch/cms-service-dqm/CAF/certification/Collisions17/13TeV/ReReco/Cert_294927-306462_13TeV_EOY2017ReReco_Collisions17_JSON_v1.txt --dryrun
...
# python crab.py -p pancakes_2018_data_UL_NANO.py -o /store/group/lpcbacon/pancakes/02/2018/UL/ -t pancakes-02 -i data_2018_UL.txt  --num-cores 2 --send-external \
#     -s EventAwareLumiBased \
...
# python crab.py -p pancakes_2016_data_UL_NANO.py -o /store/group/lpcbacon/pancakes/02/2016/UL/ -t pancakes-02 -i data_2016_UL.txt  --num-cores 2 --send-external \
#     -s EventAwareLumiBased \
