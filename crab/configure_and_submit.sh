cmsDriver.py test_nanoHRT_mc -n 1000 --mc --eventcontent NANOAODSIM --datatier NANOAODSIM \
  ...
  --customise_commands "process.options = cms.untracked.PSet ( wantSummary = cms.untracked.bool ( True ) )" --no_exec
python crab.py -p test_nanoHRT_mc_NANO.py -o /store/user/ncsmith/pancakes/01/ -t pancakes-01 -i mc_2017.txt \
  --num-cores 4 --send-external -s EventAwareLumiBased -n 50000 --work-area crab_projects_mc_2017 --dryrun 
